...
exports.smsg = (conn, citel, store) => {
  ...
  let emma = { "key": { "participants":"0@s.whatsapp.net", "remoteJid": "status@broadcast", "fromMe": false, "id": "Halo" }, "message": { "contactMessage": { "displayName": "IRIS-MD","vcard": `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${citel.sender.split('@')[0]}:${citel.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD` }}, "participant": "0@s.whatsapp.net" }
	...
	citel.replyimg = (img, teks, id = citel.chat, option = { mentions: [citel.sender] }) => conn.sendMessage(id, { image: img, caption: teks, contextInfo: { mentionedJid: option.mentions } }, { quoted: citel })
        ...
        citel.reply = async (content, opt = { packname: "🍀 Iris-MD whatsapp 🍀", author: "🎁 hai! senpai..!", thumbnailUrl: "https://i.ibb.co/G35jn3J/bot2p.jpg", source: URL }, type = "text") => {
	...
	citel.senddoc = (doc,type, id = citel.chat, option = { mentions: [citel.sender], filename: info.INFO.split(";")[1], mimetype: type,
	externalAdRepl: {
							title: info.INFO.split(";")[1],
							body: ' ',
							thumbnailUrl: ``,
							thumbnail: log0,
							mediaType: 1,
